...
namespace Com.H.Reflection
{
    public static class ReflectionExtensions
    {
        ...
        /// <summary>
        /// Gets a dictionary of enum names to their integer values for the specified enum type.
        /// </summary>
        /// <typeparam name="TEnum">The enum type (must have int as underlying type)</typeparam>
        /// <returns>Dictionary mapping enum names to their integer values</returns>
        /// <exception cref="ArgumentException">Thrown when TEnum is not an enum or doesn't have int as underlying type</exception>
